...
**[BondActivist/discord-unban-2.0.0](https://github.com/BondActivist/discord-unban-2.0.0)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/BondActivist/discord-unban-2.0.0/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `BondActivist/discord-unban-2.0.0`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/BondActivist/discord-unban-2.0.0/releases/latest) и скачайте **`.rar`** (предпочтительно)
