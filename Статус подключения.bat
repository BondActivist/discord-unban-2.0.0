...
set "GITHUB_VERSION_URL=https://raw.githubusercontent.com/BondActivist/discord-unban-2.0.0/main/.service/version.txt"
set "GITHUB_RELEASE_URL=https://github.com/BondActivist/discord-unban-2.0.0/releases/tag/"
set "GITHUB_DOWNLOAD_URL=https://github.com/BondActivist/discord-unban-2.0.0/releases/latest"
...
if !errorlevel!==0 (
    ...
    call :PrintRed "https://github.com/BondActivist/discord-unban-2.0.0/issues/417"
) else (
...
if !errorlevel!==0 (
    ...
    call :PrintRed "https://github.com/BondActivist/discord-unban-2.0.0/issues/2512#issuecomment-2821119513"
) else (
...
set "listFile=%~dp0lists\ipset-all.txt"
set "url=https://raw.githubusercontent.com/BondActivist/discord-unban-2.0.0/refs/heads/main/.service/ipset-service.txt"
...
set "hostsFile=%SystemRoot%\System32\drivers\etc\hosts"
set "hostsUrl=https://raw.githubusercontent.com/BondActivist/discord-unban-2.0.0/refs/heads/main/.service/hosts"
...
if %errorLevel% neq 0 (
    ...
    echo Fix your PATH variable with instructions here https://github.com/BondActivist/discord-unban-2.0.0/issues/7490
    pause
    exit /b 1
)
exit /b 0
